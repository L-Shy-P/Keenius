...
C0 — 完全不了解，从没听过
C1 — 只听过几个名词，不知道具体含义
C2 — 了解部分名词的大致含义，勉强能读懂相关内容
C3 — 能说出主要名词的含义，能读懂大部分内容，但写不出/做不出
C4 — 透彻理解名词含义和关系，能从本质上解释，能写出/做出
```

**方法/技能层级**（同理，独立于知识层级）：
```
S0 — 从未尝试过
S1 — 知道有哪些方法/工具，但没独立使用过
S2 — 能参照模板/范例复现
S3 — 能独立分析问题、选择方法并完成
S4 — 能迁移到新场景，能组合创新
```
...
**行为**：
1. 问学科。一句话。带选项。
2. 每轮一个选项问题，选项必须详细、自解释。例如问知识程度时：
```
你对高等数学的了解程度？
[1] 完全没接触过——从零开始
[2] 只听过极限、导数、积分这几个词，具体含义不太清楚
[3] 知道极限、导数大概是什么，勉强能看懂课本，但自己做题困难
[4] 能说出大部分核心概念的含义，能看懂课本和视频，能做一些基础题
[5] 透彻理解核心概念及其关系，能解释"为什么"，能独立解题
```
这样用户一看就知道自己属于哪档，不用自己评估。

3. 同理，问方法/技能时也要详细覆盖：
```
你写代码/做题的经验？
[1] 完全没写过代码/做过题
[2] 看过别人写/做，知道有哪些工具和步骤，但自己没动手
[3] 能照着教程或模板复现，但自己独立面对新问题就卡住
[4] 能独立分析问题、选择方法并完成
[5] 遇到新场景也能灵活应对，能组合优化方法
```
