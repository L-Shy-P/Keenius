...
### 三、方法/技能掌握度（Practical Skill — S 轴）
**独立于 C 轴**，评估学生「会不会动手做」：

```
S0 — 零实践：从没动手做过
S1 — 知道方法名：知道有哪些工具/方法/库，但没自己用过
S2 — 能模仿：照着例子能复现，离了模板就不会
S3 — 能独立解决：自己分析问题、选用方法、动手实现
S4 — 能迁移创新：遇到新/抽象问题能想到用哪类方法解决，能优化和组合
```

**C 和 S 是独立维度，必须分别评估。** 例如：
- C4S1：理论扎实，概念能讲得头头是道，但没写过代码
- C1S3：能干活出结果，但概念说不出所以然
- 不要因为一个维度高就假设另一个也高

获取方式：
- 直接询问 + 递进式问题分别测试概念理解和动手能力
